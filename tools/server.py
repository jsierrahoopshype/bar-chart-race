        ...
        if parsed.path == "/api/comparison/preview":
            ...
            try:
                ...
                ccfg = ComparisonConfig(
                    ...
                    category_bg=config.get("category_bg", "#f0f0f0"),
                    category_text_color=config.get("category_text_color", "#000000"),
                    category_font_size=int(config.get("category_font_size", 22)),
                    winner_bg=config.get("winner_bg", "#CC0000"),
                    winner_text_color=config.get("winner_text_color", "#FFFFFF"),
                    winner_font_size=int(config.get("winner_font_size", 24)),
                    other_bg=config.get("other_bg", "#2a2a2a"),
                    other_text_color=config.get("other_text_color", "#FFFFFF"),
